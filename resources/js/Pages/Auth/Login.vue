            ...
            <div class="mt-4 flex items-center justify-between">
                <div class="flex flex-col gap-2">
                    ...
                    <Link
                        ...
                        class="rounded-md text-sm text-indigo-600 dark:text-indigo-400 underline hover:text-indigo-900 dark:hover:text-indigo-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                    >
                        Daftar sebagai Guru →
                    </Link>
                </div>
