...
<body style="margin:0;padding:0;background:#f6f7fb;font-family:Arial,Helvetica,sans-serif;color:#1f2937;">
    <div style="max-width:640px;margin:0 auto;padding:32px 16px;">
        <div
            ...
            <p style="margin:0 0 20px;font-size:15px;line-height:1.7;">Halo {{ $name }}, selamat! Pendaftaran akun guru Anda telah kami setujui. Anda sekarang dapat login menggunakan email dan password yang telah Anda daftarkan.</p>
            ...
            <p style="margin:0;font-size:13px;line-height:1.7;color:#6b7280;">Silakan klik tombol di atas untuk masuk ke portal guru. Jika Anda memiliki pertanyaan, jangan ragu untuk menghubungi kami.</p>
        </div>
    </div>
</body>
